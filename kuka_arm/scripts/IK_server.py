...
def handle_calculate_IK(req):
	...
	# LINK 1 (i = 1)
        ...
        # LINK 2
        T0_2 = Matrix([[            cos(q2),            -sin(q2),            0,              a1]
        ...
        # LINK 3
        T0_3 = Matrix([[            cos(q3),            -sin(q3),            0,              a2]
        ...
        # LINK 4 
        T0_4 = Matrix([[            cos(q4),            -sin(q4),            0,              a3]
        ...
        # LINK 5
        T0_5 = Matrix([[            cos(q5),            -sin(q5),            0,              a4]
        ...
        # LINK 6
        T0_6 = Matrix([[            cos(q6),            -sin(q6),            0,              a5]
